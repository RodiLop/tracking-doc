        ...
        return (
            <div className="admin-container">
                <div className="form-group">
                    ...
                    <br/>
                    <select type="text" className="form-control col-lg-3 m-auto" id="doc-type" value={this.state.currentType} name="currentType" onChange={this.handleChange}>
                        {this.state.tiposDocumento.map((tipo) => <option key={tipo} value={tipo}>{tipo}</option>)}
                    </select>
                </div>
                <div>
                    <AdminLink list={this.state.list} currentType={this.state.currentType}/>
                </div>
            </div>
        )
    }
